...
class Topology(Topo):
    """BGP-aware generalized multi-tenant SDX topology.
    ...
    The physical topology matches the generalized SDX topology, but the FRR control-plane
    configuration advertises host /32 prefixes selectively across the slow and fast
    transit ASes. This creates sessions with different BGP-reachable egress sets, which
    the SDX controller can query and respect at runtime.
    """
